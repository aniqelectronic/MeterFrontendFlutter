...
import 'package:frontend_v1/services/weather/weather_service.dart';
...
//
// ============================================================================
class PWeatherPage extends StatefulWidget {
  const PWeatherPage({
    super.key,
  });

  @override
  State<PWeatherPage> createState() =>
      _PWeatherPageState();
}

class _PWeatherPageState
    extends State<PWeatherPage> {
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 48,
            child:
                _ModernWeatherHeader(
              title:
                  loc.weatherPageTitle(
                Data.weatherPlaceName,
              ),
              subtitle:
                  loc.weatherPageSubtitle(
                Data.weatherPlaceName,
              ),
            ),
          ),
          ...
          Positioned(
            ...
            child:
                _DisclaimerCard(
              title:
                  loc.weatherDisclaimerTitle,
              message:
                  loc.weatherDisclaimerText,
            ),
          ),
  ...
  Widget _buildBody(
    ...
    if (_loading) {
      return _StatusCard(
        ...
        title:
            loc.weatherLoadingTitle,
        message:
            loc.weatherLoadingMessage,
        child:
            const SizedBox(
          width: 58,
          height: 58,
    ...
    if (_error != null &&
      ...
      return _StatusCard(
        ...
        title:
            loc.weatherUnavailableTitle,
        message:
            loc.weatherUnavailableMessage,
        child:
            ElevatedButton.icon(
          onPressed: () =>
              _loadWeather(
...
IconData _weatherIcon(
  ...
  // IMPORTANT:
  // Check "tiada hujan" BEFORE "hujan".
  //
  // Otherwise "Tiada Hujan" also contains the word "hujan"
  // and would incorrectly show the rain icon.
  if (value.contains(
    'tiada hujan',
  )) {
    return Icons
...
// ============================================================================
//
// data.gov.my returns forecast descriptions mainly in Malay.
//
// We normalize:
// - capitalization
// - spaces
  ...
  const translations =
    ...
    'hujan di satu dua tempat di kawasan pantai':
      ...
      'zh':
          '沿海一两个地区有雨',
      'ta':
          'கடலோரத்தின் ஓரிரு இடங்களில் மழை',
    },
    ...
    'hujan di satu dua tempat di kawasan pedalaman':
      ...
      'zh':
          '内陆一两个地区有雨',
      'ta':
          'உள்நாட்டின் ஓரிரு இடங்களில் மழை',
    },
    ...
    'ribut petir di beberapa tempat di kawasan pedalaman':
      ...
      'zh':
          '内陆局部地区有雷暴',
      'ta':
          'உள்நாட்டின் சில இடங்களில் இடியுடன் கூடிய மழை',
    },
    ...
    'ribut petir di satu dua tempat':
      ...
      'zh':
          '一两个地区有雷暴',
      'ta':
          'ஓரிரு இடங்களில் இடியுடன் கூடிய மழை',
    },
    ...
    'ribut petir di satu dua tempat di kawasan pantai':
      ...
      'zh':
          '沿海一两个地区有雷暴',
      'ta':
          'கடலோரத்தின் ஓரிரு இடங்களில் இடியுடன் கூடிய மழை',
    },
    ...
    'ribut petir di satu dua tempat di kawasan pedalaman':
      ...
      'zh':
          '内陆一两个地区有雷暴',
      'ta':
          'உள்நாட்டின் ஓரிரு இடங்களில் இடியுடன் கூடிய மழை',
    },
  };
