...
class P5SemakanSewaanBentongScreen extends StatefulWidget {
  const P5SemakanSewaanBentongScreen({
    super.key,
  });
...
class _P5SemakanSewaanBentongScreenState
  ...
  void initState() {
    ...
    paymentList =
        SemakanSewaanBentongService.paymentList;
  }
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // MAIN CONTENT
          //
          // The 275 bottom padding reserves space for the back
          // panel so that the table cannot go behind it.
          // ===================================================
