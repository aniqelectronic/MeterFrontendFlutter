...
class P5SemakanSewaanBentongScreen extends StatefulWidget {
  const P5SemakanSewaanBentongScreen({super.key});

  @override
  State<P5SemakanSewaanBentongScreen> createState() =>
      _P5SemakanSewaanBentongScreenState();
}

class _P5SemakanSewaanBentongScreenState
    extends State<P5SemakanSewaanBentongScreen> {
  ...
  void initState() {
    super.initState();
    paymentList = SemakanSewaanBentongService.paymentList;
  }
  ...
  Widget _tableHeader(double fontSize, AppLocalizations loc) {
    return Container(
      ...
      child: Row(
        children: [
          _fixedHeader(loc.accountNo, 300, fontSize),
          _fixedHeader(loc.bankTransactionNo, 300, fontSize),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          _modernDetailRow(
                            loc.tenantName,
                            _value(item, "tenant_name"),
                            Icons.person,
                          ),
                          _modernDetailRow(
                            loc.premiseAddress,
                            _value(item, "premise_address"),
                            Icons.store,
                          ),
                          _modernDetailRow(
                            loc.orderNo,
