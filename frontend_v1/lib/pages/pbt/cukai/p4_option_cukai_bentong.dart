        ...
        children: [
          ...
          Positioned(
            ...
            child: _ModernPageHeader(
              badgeText: loc.assessmentTaxServiceLabel,
              title: loc.p4optioncukaiTitle,
              subtitle: loc.p4optioncukaiSubtitle,
            ),
          ),
              ...
              children: [
                ...
                Expanded(
                  child: _ModernTextServiceButton(
                    height: 470,
                    visualText: 'RM',
                    label: loc.paymenttax,
                    supportingText: loc.paymentTaxSupportingText,
                ...
                Expanded(
                  child: _ModernTextServiceButton(
                    height: 470,
                    visualText: '✓',
                    label: loc.checkbuttontax,
                    supportingText: loc.checkTaxSupportingText,
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0xFF7B4DE3).withOpacity(0.10),
            borderRadius: BorderRadius.circular(100),
            border: Border.all(
              color: const Color(0xFF7B4DE3).withOpacity(0.25),
              width: 1.5,
            ),
          ),
          child: Row(
