...
import 'package:frontend_v1/pages/payment/bill/digital_voucher_qr_payment_page.dart';

// ============================================================================
// DIGITAL VOUCHER SELECTION RESULT
// ============================================================================
...
class PDIGITALVOUCHER4PAGE extends StatefulWidget {
  final String productCode;
  final String productName;
  final String imageUrl;

  const PDIGITALVOUCHER4PAGE({
    super.key,
    required this.productCode,
    required this.productName,
    required this.imageUrl,
  ...
  @override
  State<PDIGITALVOUCHER4PAGE> createState() =>
      _PDIGITALVOUCHER4PAGEState();
}

class _PDIGITALVOUCHER4PAGEState
    extends State<PDIGITALVOUCHER4PAGE> {
  // ==========================================================================
  // CONTROLLERS
  // ==========================================================================
  ...
  //
  // Known Digital Voucher products use ARB.
  //
  // If IIMMPACT adds a new Digital Voucher later:
  //
  ...
  String _localizedNote(
    ...
    switch (_code) {
      case 'AD':
        return loc
            .digitalVoucherNoteAdidas;

      case 'DISCORD':
        return loc
            .digitalVoucherNoteDiscord;

      case 'ECT':
        return loc
            .digitalVoucherNoteEatCakeToday;

      case 'GC':
        return loc
            .digitalVoucherNoteGrabGiftCode;

      case 'GF':
        return loc
            .digitalVoucherNoteGrabFood;

      case 'GM':
        return loc
            .digitalVoucherNoteGrabMart;

      case 'SE':
        return loc
            .digitalVoucherNoteShopee;

      case 'ZAL':
        return loc
            .digitalVoucherNoteZalora;

      default:
        // ================================================================
        // NEW / UNKNOWN PRODUCT
        //
        // Show the original IIMMPACT note until we add an ARB translation.
        // ================================================================
          ...
          Expanded(
            child:
              ...
              children: [
                ...
                Text(
                  loc.digitalVoucherPurchaseSubtitle,
                  style:
                      const TextStyle(
                    color:
                        Colors.white70,
