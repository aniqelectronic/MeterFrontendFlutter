...
/// Specialized C200 service for "Compound" transactions
class CompoundC200Service extends AbstractC200TransactionService {
  ...
  @override
  String getTransactionTypeLabel() => "C200 Sale-Compound";
  ...
  Future<void> _ensureTransport(String path) async {
    if (transport == null || !transport!.isOpen) {
      print('[CompoundC200Service] Creating NATIVE transport for: $path');
      transport = IM15NativeSerialTransport(path, connMgr.cfg);
      await transport!.ensureOpen();
      print('[CompoundC200Service] ✅ Native transport opened successfully');
    }
  }
